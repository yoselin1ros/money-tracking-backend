...
@Entity
@Table(name = "onboarding_statuses", schema = "migrations")
public class OnboardingStatusEntity {
    @Id
    ...
    public String toString() {
        return "OnboardingStatusEntity [id=" + id + ", user=" + user + ", status=" + status + ", completedAt="
